  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Manage all external API keys and configurations</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">MongoDB Configuration</h3>
          </div>
          <div className="space-y-4">
            ...
            <button
              onClick={() => onSave('apis', apiConfigs)}
        ...
        {/* Add more API configurations similarly */}
      </div>
    </div>
  );
};
